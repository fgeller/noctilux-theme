      ...
      (let ((back base03))
        ...
        (let ((bg-back   `(:background ,back))
          ...
          `((;; basic
             ...
             (mode-line-buffer-id
              ((t (,@fg-violet ,@bg-base02 :box nil))))
             (mode-line-emphasis
              ((t (,@fg-green ,@bg-base02 ,@fmt-revbb :box nil))))
             (mode-line-highlight
              ((t (,@fg-green ,@bg-base02 ,@fmt-revbb :box nil))))
             ...
             ;; dired+
             (diredp-dir-heading ((t (,@fg-base1 ,@bg-back))))
             (diredp-dir-priv ((t (,@fg-base1 ,@bg-back))))
             (diredp-exec-priv ((t (,@fg-base1 ,@bg-back))))
             (diredp-file-name ((t (,@fg-base1 ,@bg-back))))
             (diredp-file-suffix ((t (,@fg-base1 ,@bg-back))))
             (diredp-compressed-file-suffix ((t (,@fg-base1 ,@bg-back))))
             (diredp-flag-mark-line ((t (,@fg-base1 ,@bg-back))))
             (diredp-ignored-file-name ((t (,@fg-base1 ,@bg-back))))
             (diredp-link-priv ((t (,@fg-base1 ,@bg-back))))
             (diredp-no-priv ((t (,@fg-base1 ,@bg-back))))
             (diredp-number ((t (,@fg-base1 ,@bg-back))))
             (diredp-other-priv ((t (,@fg-base1 ,@bg-back))))
             (diredp-rare-priv ((t (,@fg-base1 ,@bg-back))))
             (diredp-read-priv ((t (,@fg-base1 ,@bg-back))))
             (diredp-symlink ((t (,@fg-base1 ,@bg-back))))
             (diredp-write-priv ((t (,@fg-base1 ,@bg-back))))
             (diredp-deletion ((t (,@fg-base1 ,@bg-back))))
             (diredp-deletion-file-name ((t (,@fg-base1 ,@bg-back))))
             (diredp-date-time ((t (,@fg-base1 ,@bg-back))))
             ;; helm
             (helm-action ((t (,@fg-base1 ,@bg-back))))
             (helm-selection ((t (:underline ,opt-under ,@bg-base02))))
             (helm-candidate-number ((t (,@fg-base1 ,@bg-back))))
             (helm-source-header ((t (,@fg-yellow ,@bg-back))))
             (helm-visible-mark ((t (,@fg-red ,@bg-back))))
             (helm-ff-directory ((t (,@fg-green ,@bg-back))))
             (helm-ff-executable ((t (,@fg-orange ,@bg-back))))
             (helm-ff-symlink ((t (,@fg-magenta ,@bg-back))))
             (helm-ff-prefix ((t (,@fg-yellow ,@bg-back))))
             (helm-M-x-key ((t (,@fg-violet ,@bg-back))))
             (helm-grep-file ((t (,@fg-base1 ,@bg-back))))
             (helm-grep-lineno ((t (,@fg-base1 ,@bg-back))))
             (helm-grep-running ((t (,@fg-base1 ,@bg-back))))
             (helm-grep-finish ((t (,@fg-base1 ,@bg-back))))
             (helm-buffer-saved-out ((t (,@fg-base1 ,@bg-back))))
             (helm-moccur-buffer ((t (,@fg-base1 ,@bg-back))))
             ;; IDO
